...
SCENARIO("positions can be added and subtracted")
{
    GIVEN("two positions")
    {
        auto position1 = thrifty::units::position_sixdof_t{1_m, 1_km, 1_ft, 1_deg, 1_rad, 1_rad};
        auto position2 = thrifty::units::position_sixdof_t{1_ft, 1_m, 1_cm, 1_rad, 1_deg, 1_rad};
        ...
        {
            auto position3 = thrifty::units::position_sixdof_t{};
...
SCENARIO("positions can be multiplied and divided by a factor")
{
    ...
    {
        auto position = thrifty::units::position_sixdof_t{1_m, 1_km, 1_ft, 1_deg, 1_rad, 1_rad};
        auto factor = 2.0;
        ...
        {
            auto positionMultiplied = thrifty::units::position_sixdof_t{};
        ...
        {
            auto positionDivided = thrifty::units::position_sixdof_t{};
